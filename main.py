...
Usage:
  ...
  python main.py --score-explain "task name" impact effort alignment
  python main.py --demo
"""
...
def main():
    ...
    parser.add_argument("--benchmark", action="store_true", help="Run APEX vs default Claude comparison")
